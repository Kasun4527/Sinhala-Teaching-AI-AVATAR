    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            A personalized learning experience powered by AI — tailored to your
            level, your pace, your goals.
          </p>
          ...
          >
            {["AI-Powered", "Adaptive", "Progress Tracking", "Multi-Level"].map(
              (f) => (
                <span
                  key={f}
                  style={{
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            {[
              ...
              { name: "Buddhist Studies", color: "#ea580c" },
            ].map((s) => (
              <div
                key={s.name}
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div
              ...
              style={{
                backgroundColor:
                  hoveredRole === "student" ? "#eff6ff" : "white",
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 12,
                  backgroundColor:
                    hoveredRole === "student" ? "#2563eb" : "#f1f5f9",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0,
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 12,
                  backgroundColor:
                    hoveredRole === "admin" ? "#1e293b" : "#f1f5f9",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0,
