...
export default function Sidebar({ subject: activeSub = null }) {
  ...
  return (
    <>
      ...
      >
        <span style={{ width: 18, height: 2, background: "#cbd5e1", borderRadius: 2 }} />
        <span style={{ width: 18, height: 2, background: "#cbd5e1", borderRadius: 2 }} />
        <span style={{ width: 18, height: 2, background: "#cbd5e1", borderRadius: 2 }} />
      </button>
      ...
      <div style={{
        ...
        width: isCollapsed ? 0 : 230, minWidth: isCollapsed ? 0 : 230,
        opacity: isCollapsed ? 0 : 1,
        minHeight: "100vh",
        display: "flex", flexDirection: "column",
        justifyContent: "space-between",
        borderRight: isCollapsed ? "none" : "1px solid #1e293b",
        flexShrink: 0,
        overflow: "hidden",
        ...
        <div style={{ overflowY: "auto", flex: 1, scrollbarWidth: "none", msOverflowStyle: "none" }}>
          ...
          {/* Logo */}
          <div style={{ padding: "18px 16px 16px 64px", borderBottom: "1px solid #1e293b", whiteSpace: "nowrap" }}>
          ...
          {/* Dashboard nav */}
          <div style={{ padding: "12px 10px 4px", whiteSpace: "nowrap" }}>
            <div
          ...
          {activeSub && subjectData && (() => {
            ...
            return (
              <div style={{ padding: "0 10px 8px", whiteSpace: "nowrap" }}>
